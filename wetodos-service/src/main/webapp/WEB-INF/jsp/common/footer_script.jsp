<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<script type="text/javascript" src="assets/js/vendor/jquery-migrate-1.1.1.min.js"></script>
	...
	<script type="text/javascript" src="assets/js/lib/summernote.js"></script>
	<script type="text/javascript" src="assets/js/lib/summernote-zh-CN.js"></script>
	<!-- 图片剪裁脚本 -->
