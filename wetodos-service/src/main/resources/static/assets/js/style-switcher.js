...
var styleSwitcher = {
    ...
    build: function() {
        ...
        var h5 = $('<h5 />').html('样式风格切换面板').append(h5A);
        ...
        var topNavBarStatic = $('<a/>').html('静态').attr('href', '#').on('click', function(e) {
            e.preventDefault();
            $(this).addClass('active').siblings('a').removeClass('active');
            $('body').removeClass('padTop44');
            $('#top .navbar').removeClass('navbar-fixed-top').addClass('navbar-static-top');
        });
        var topNavBarFixed = $('<a/>').html('固顶').attr('href', '#').on('click', function(e) {
            e.preventDefault();
            $(this).addClass('active').siblings('a').removeClass('active');
        ...
        var sideLeftLink = $('<a/>').html('左').attr('href', '#').on('click', function(e) {
            e.preventDefault();
        ...
        var sideRightLink = $('<a/>').html('右').attr('href', '#').on('click', function(e) {
            e.preventDefault();
            $(this).addClass('active');
        ...
        var sideMiniLink = $('<a/>').html('小图标').attr('href', '#').on('click', function(e) {
            e.preventDefault();
            $(this).addClass('active');
            sideMaxiLink.removeClass('active');
            $('body').addClass('mini-sidebar');
        });
        var sideMaxiLink = $('<a/>').html('大菜单').attr('href', '#').on('click', function(e) {
            e.preventDefault();
            $(this).addClass('active');
